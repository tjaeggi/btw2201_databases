...
Siehe pdf-File auf Moodle!

![Anleitung Strassenverzeichnis](<pdf/AnleitungStrassenverzeichnisse.pdf>){ type=application/pdf style="min-height:50vh;width:100%" }


## CSV-Datei
[Post_Adressdaten-20240903.zip](static/Post_Adressdaten-20240903.zip){:download="CSV-Datei gezipped"}