# UE06-03-Schuldatenbank erstellen in MySQL
...
!!! example "Aufgabe 1"
    ...
    * Pro Fach kann ein Schüler jeweils eine numerscihe Note von 1-6 erzielen (eine Kommanstelle Präzision reicht) 
    ...
    Versuche die nötigen Tabellen in der **3ten Normalform** zu entwickeln. Gehe dabei methodisch vor: siehe Folien auf Moodle.
