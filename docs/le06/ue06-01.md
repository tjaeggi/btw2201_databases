...
Erstellen Sie die Datenbank (Schema) und die Tabellen in MySQL. Verwenden Sie dazu SQL-Befehle. Als Werkzeug können Sie eines der drei vorgestellten Tools verwenden: phpMyAdmin, MySQL Workbench oder mysql-CLI. Empfehlung: MySQL Workbench.
