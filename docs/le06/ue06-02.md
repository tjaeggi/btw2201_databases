...
## Normalformen - Aufgabe als Repetition
...
!!! success "Antworten"
    ...
    Es handelt sich hier um eine m-m-Beziehung zwischen Modul und Student: 1 Stundet belegt mehrere Module und 1 Modul kann von mehreren Studenten belegt werden.

    Wie wir wissen, dass eine m-m Beziehung eine Beziehungstabelle bedingt.
    ...
    * Student_Modul (<u>id_Student</u>, <u>idModul</u>, Note)
    ...
    Transitive Abhängigkeiten sind hier nicht zu finden, daher befinden sich diese Tabellen in 3NF.
...
## Erstellung 3NF Normalform - Aufgabe als Repetition
