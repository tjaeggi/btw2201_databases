...
Lassen Sie dieses ERM in Ihrer Installation mit MySQL-Workbench erstellen! Verwenden Sie dazu die Funktion "Reverse Engineer".

<figure markdown="span">
![Image title](../static/ERM-chinook.png){ width="500" }
<figcaption>ERM generiert aus MYSQL-Workbench</figcaption>
</figure>