...
!!! Aufgabe
     ...
     **WICHTIG zu beachten**: Die Tabellen müssen von der Engine `InnoDB` verwaltet werden, damit die Transaktion korrekt abläuft. Kontrolliere, ob dies der Fall ist mit dem Befehl: `SHOW TABLE STATUS;`
