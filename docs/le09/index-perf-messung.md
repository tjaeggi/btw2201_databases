...
!!! danger "Performancesteigerung mit Faktor 8000 !!!"
    ...
    Führe beide SQLs, zuerst  `01-IDX_Messung_CreateDB_LoadDATA.sql` und dann `02-IDX_Messung_bank_bankneu.sql` in der MySQL-Workbench aus. Das 1. Skript kann einfach als Ganzes gestartet werden. Das 2. SQL-Skript ist kommentiert, beinhalten auch neue
    Befehle für die Messung von Ausführungszeiten von SELECT-Befehlen und soll Schritt für Schritt durchgeführt werden.
