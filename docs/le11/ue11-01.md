...
!!! example "UE11-01-Wetterdaten importieren mit Python Skript"
    ...
    Erstelle ein Python-Skript, das Wetterdaten von der OpenWeatherMap-API abruft und in ein InfluxDB-Bucket für den Standort die Standorte Berne, Geneva und Samedan importiert.
